...
s8 = st.number_input("ปริมาณครีเอทินีนในซีรั่ม (มิลลิกรัม/เดซิลลิตร)")
s9 = st.number_input("ปริมาณโซเดียมในซีรั่ม (มิลลิเอควิเทลนต์/ลิตร)")
...
if st.button("ทำนายผล"):
   ...
   if out[0]== 0 :
      ...
      <left><h6 style="text-indent: 30px;line-height: 1.5;padding-top:15px;">ภาวะหัวใจล้มเหลว เกิดจากหัวใจทำงานผิดปกติ ทำให้ไม่สามารถสูบฉีดเลือดไปเลี้ยงส่วนต่างๆ ของร่างกายได้อย่างเพียงพอ สาเหตุที่พบบ่อย ได้แก่ โรคหลอดเลือดหัวใจตีบ โรคความดันโลหิตสูง โรคกล้ามเนื้อหัวใจอักเสบ โรคลิ้นหัวใจผิดปกติ เป็นต้น อาการที่พบ ได้แก่ หายใจลำบาก เหนื่อยล้า บวมตามแขนขา เป็นต้น
ภาวะหัวใจล้มเหลวเป็นภาวะที่อาจนำไปสู่ความพิการหรือเสียชีวิตได้ ดังนั้น หากมีอาการของภาวะหัวใจล้มเหลว ควรรีบไปพบแพทย์เพื่อรับการตรวจวินิจฉัยและรักษาอย่างถูกต้อง</h6></left>
      <ul>
