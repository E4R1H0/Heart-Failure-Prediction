...
if st.button("ทำนายผล"):
   ...
   if out[0]== 0 :
      ...
      <ul>
         ...
         <li>ค่าเฉลี่ยจำนวนเกร็ดเลือดในเลือด (หน่วย กิโลเกร็ดเลือด/มิลลิลิตร)ของผู้ป่วยที่เสียชีวิตคือ 256381 กิโลเกร็ด/มิลลิลิตร</li>
         <li>ค่าเฉลี่ยปริมาณซีรั่มครีเอทินีนในเลือด (มิลลิกรัม/เดซิลลิตร)ของผู้ป่วยที่เสียชีวิตคือ 1.83 มิลลิกรัม/เดซิลลิตร </li>
         <li>ค่าเฉลี่ยปริมาณซีรั่มโซเดียมในเลือด (มิลลิเอควิเทลนต์/ลิตร)ของผู้ป่วยที่เสียชีวิตคือ 135 มิลลิเอควิเทลนต์/ลิตร</li>
      </ul>
