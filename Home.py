...
s7 = st.number_input("จำนวนเกล็ดเลือดในเลือด (พันเกล็ดเลือด/มิลลิลิตร)")
...
if st.button("ทำนายผล"):
   ...
   if out[0]== 0 :
      ...
      <ul>
         ...
         <li>อัตราส่วนร้อยละของเลือดที่สูบออกจากหัวใจในแต่ละครั้งโดยปกติแล้วในคนปกติจะมีค่าอยู่ที่ร้อยละ60 ส่วนผู้ป่วยที่เสียชีวิตอยู่ที่ร้อยละ30 การรักษาที่อาจช่วยเพิ่มเศษอีเจ็คชัน ได้แก่ ยา ยาบางชนิด เช่น ยาขยายหลอดเลือดหัวใจ ยาลดความดันโลหิต และยาขับปัสสาวะ สามารถช่วยปรับปรุงการทำงานของหัวใจและเพิ่มเศษอีเจ็คชัน</li>
