...
html_1 = """
<div style="background-color:#E0FFFF;margin-top:40px;padding:5px;border-radius:5px;border-bottom: 3px solid #ffffff;border-top: 3px solid #ffffff;">
...
html_6 = """
<div style="background-color:#E0FFFF;border-bottom: 3px solid #ffffff;border-top: 3px solid #ffffff;">
<center><h3>Example data table</h3></center>
</div>
"""
...
html_7 = """
<div style="background-color:#E0FFFF;border-bottom: 3px solid #ffffff;border-top: 3px solid #ffffff;margin-top:20px;">
...
if st.button("ทำนายผล"):
   ...
   if out[0]== 0 :
      ...
      html_8 = """
      <div style="background-color:#E0FFFF;padding:20px;border: 3px solid #ffffff;">
      ...
      <ul>
         <li>อายุเฉลี่ยของผู้ป่วยที่เสียชีวิตจากภาวะหัวใจล้มเหลวคือ 68 ปี อายุมากสุดคือ 95 ปี</li>
         <li>ค่าเฉลี่ยของเอนไซม์CPKในเลือดของผู้ป่วยที่เสียชีวิตคือ 583mcg/L ค่าน้อยสุดเอนไซม์CPKในเลือดของผู้ป่วยที่เสียชีวิตคือ23mcg/L ส่วนมากสุดคือ 7861mcg/L สำหรับผู้ที่มีความเสี่ยงชีวิตมากแนะนำให้ลดปริมาณเอนไซม์CPKลง</li>
         <li>ร้อยละของเลือดที่สูบออกจากหัวใจในแต่ละครั้ง(ejection fraction)หรือเศษอีเจ็คชันโดยปกติแล้วในคนปกติจะมีค่าเฉลี่ยอยู่ที่ร้อยละ60 ส่วนผู้ป่วยที่เสียชีวิตมีค่าเฉลี่ยอยู่ที่ร้อยละ34 ค่ามากสุดคือร้อยละ70 ส่วนค่าน้อยสุดคือ15 การรักษาที่อาจช่วยเพิ่มเศษอีเจ็คชัน ได้แก่ 1.ยาบางชนิด เช่น ยาขยายหลอดเลือดหัวใจ 2.การผ่าตัด การผ่าตัดบางประเภท เช่น การผ่าตัดบายพาสหัวใจหรือการผ่าตัดรักษาโรคลิ้นหัวใจผิดปกติ สามารถช่วยปรับปรุงการทำงานของหัวใจและเพิ่มเศษอีเจ็คชัน 3.การเปลี่ยนแปลงวิถีชีวิต การเปลี่ยนแปลงวิถีชีวิต เช่น การรับประทานอาหารเพื่อสุขภาพ การลดน้ำหนัก การเลิกสูบบุหรี่ และการออกกำลังกายอย่างสม่ำเสมอ สามารถช่วยปรับปรุงการทำงานของหัวใจและเพิ่มเศษอีเจ็คชัน</li>
         <li>ค่าเฉลี่ยจำนวนเกร็ดเลือดในเลือด (หน่วย กิโลเกร็ดเลือด/มิลลิลิตร)ของผู้ป่วยที่เสียชีวิตคือ 256381 กิโลเกร็ด/มิลลิลิตร ค่ามากสุดคือ 621000 กิโลเกร็ด/มิลลิลิตร และต่ำสุดคือ 47000 กิโลเกร็ด/มิลลิลิตร</li>
         <li>ค่าเฉลี่ยปริมาณซีรั่มครีเอทินีนในเลือด (มิลลิกรัม/เดซิลลิตร)ของผู้ป่วยที่เสียชีวิตคือ 1.83 มิลลิกรัม/เดซิลลิตร มากสุดคือ 9.4 มิลลิกรัม/เดซิลลิตร และ น้อยสุดคือ 0.6 มิลลิกรัม/เดซิลลิตร</li>
         <li>ค่าเฉลี่ยปริมาณซีรั่มโซเดียมในเลือด (มิลลิเอควิเทลนต์/ลิตร)ของผู้ป่วยที่เสียชีวิตคือ 135 มิลลิเอควิเทลนต์/ลิตร มากสุดคือ 146 มิลลิเอควิเทลนต์/ลิตร และน้อยสุดคือ 116 มิลลิเอควิเทลนต์/ลิตร</li>
      </ul>
      <left><h6 style="text-indent: 30px;line-height: 1.5;padding-top:15px;">ข้อมูลนี้มาจากการวิเคราะห์ชุดข้อมูลของผู้ป่วยโรคหัวใจและหลอดเลือดที่อายุมากกว่า50ปี สามารถนำข้อมูลเหล่านี้ไปปรับใช้เพื่อลดความเสี่ยงภาวะหัวใจล้มเหลวให้ผู้ป่วยโรคหัวใจและหลอดเลือดได้</h6></left>
      </div>
      """
