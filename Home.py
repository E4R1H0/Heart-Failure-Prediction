...
s8 = st.number_input("ปริมาณครีเซรั่มเอทินีนในเลือด (มิลลิกรัม/เดซิลลิตร)")
s9 = st.number_input("ปริมาณเซรั่มโซเดียมในเลือด (มิลลิเอควิเทลนต์/ลิตร)")
...
if st.button("ทำนายผล"):
   ...
   if out[0]== 0 :
      ...
      <left><h6 style="text-indent: 30px;line-height: 1.5;padding-top:15px;">ภาวะหัวใจล้มเหลวเป็นภาวะแทรกซ้อนที่พบบ่อยของโรคหัวใจและหลอดเลือด จากข้อมูลของผู้ป่วยที่เสียชีวิตพบว่าค่าเฉลี่ยของข้อมูลต่างๆมีดังนี้</h6></left>
      <ul>
         <li>อายุเฉลี่ยของผู้ป่วยที่เสียชีวิตจากภาวะหัวใจล้มเหลวคือ 61 ปี</li>
         <li>ค่าเฉลี่ยของเอนไซม์CPKในเลือดของผู้ป่วยที่เสียชีวิตคือ 670mcg/L สำหรับผู้ที่มีความเสี่ยงชีวิตมากแนะนำให้ลดปริมาณเอนไซม์CPKลง</li>
         <li>ร้อยละของเลือดที่สูบออกจากหัวใจในแต่ละครั้ง(ejection fraction)หรือเศษอีเจ็คชันโดยปกติแล้วในคนปกติจะมีค่าอยู่ที่ร้อยละ60 ส่วนผู้ป่วยที่เสียชีวิตอยู่ที่ร้อยละ30 การรักษาที่อาจช่วยเพิ่มเศษอีเจ็คชัน ได้แก่ ยา ยาบางชนิด เช่น ยาขยายหลอดเลือดหัวใจ ยาลดความดันโลหิต และยาขับปัสสาวะ การผ่าตัด การผ่าตัดบางประเภท เช่น 
         การผ่าตัดบายพาสหัวใจหรือการผ่าตัดรักษาโรคลิ้นหัวใจผิดปกติ สามารถช่วยปรับปรุงการทำงานของหัวใจและเพิ่มเศษอีเจ็คชัน
         การเปลี่ยนแปลงวิถีชีวิต การเปลี่ยนแปลงวิถีชีวิต เช่น การรับประทานอาหารเพื่อสุขภาพ การลดน้ำหนัก การเลิกสูบบุหรี่ และการออกกำลังกายอย่างสม่ำเสมอ สามารถช่วยปรับปรุงการทำงานของหัวใจและเพิ่มเศษอีเจ็คชัน</li>
         <li>จำนวนเกร็ดเลือดในเลือด (หน่วย กิโลเกร็ดเลือด/มิลลิลิตร)</li>
