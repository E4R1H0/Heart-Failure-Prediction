...
if st.button("ทำนายผล"):
   ...
   if out[0]== 0 :
      ...
      <ul>
         ...
         <li>ค่าเฉลี่ยของเอนไซม์CPKในเลือดของผู้ป่วยที่เสียชีวิตคือ 670mcg/L และของผู้ป่วยที่ไม่เสียชีวิตคือ 540mcg/L สำหรับผู้ที่มีความเสี่ยงชีวิตมากแนะนำให้ลดปริมาณเอนไซม์CPKลง</li>
         <li>อัตราส่วนร้อยละของเลือดที่สูบออกจากหัวใจในแต่ละครั้งโดยปกติแล้วในคนปกติจะมีค่าอยู่ที่ร้อยละ60 และผู้ป่วยที่ไม่เสียชีวิตมีค่าเฉลี่ยอยู่ที่ร้อยละ40 ส่วนผู้ป่วยที่เสียชีวิตอยู่ที่ร้อยละ30 การรักษาที่อาจช่วยเพิ่มเศษอีเจ็คชัน ได้แก่ ยา ยาบางชนิด เช่น ยาขยายหลอดเลือดหัวใจ ยาลดความดันโลหิต และยาขับปัสสาวะ สามารถช่วยปรับปรุงการทำงานของหัวใจและเพิ่มเศษอีเจ็คชัน</li>
